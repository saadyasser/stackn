...
<!-- Mirrored from techydevs.com/demos/themes/html/disilab-demo/disilab/questions-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Jul 2021 10:18:48 GMT -->
                    ...
                    <div class="question-main-bar">
                        ...
                        <div class="questions-snippet border-top border-top-gray">
                            ...
                            <div class="media media-card rounded-0 shadow-none mb-0 bg-transparent py-3 px-0 border-bottom border-bottom-gray">
                                ...
                                <div class="media-body">
                                    <h5 class="mb-2 fw-medium"><span class="badge bg-success mr-2 text-white fs-13">+100</span><a href="question-details.html">Bootstrap select pass value with disabled</a></h5>
                                    <p class="mb-2 truncate lh-20 fs-15">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                                    <div class="tags">
                                        <a href="#" class="tag-link">javascript</a>
                                        <a href="#" class="tag-link">bootstrap-4</a>

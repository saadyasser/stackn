...
<!-- Mirrored from techydevs.com/demos/themes/html/disilab-demo/disilab/home-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Jul 2021 10:18:11 GMT -->
    ...
    <header class="header-area bg-white">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-2">
                    <div class="logo-box">
                        <a href="index.html" class="logo"><img src="{{ asset('assets/front/images/logo-black.png') }}" alt="logo"></a>
                    ...
                    <div class="menu-wrapper border-left border-left-gray pl-4 justify-content-end">
                        ...
                        <form action="#" method="post" class="mr-4">
                            <div class="form-group mb-0">
                                @csrf
                                <input class="form-control form--control form--control-bg-gray" type="text" name="word" placeholder="Type your search words...">
                                ...
                                <li class="dropdown user-dropdown">
                                    <a class="nav-link dropdown-toggle dropdown--toggle pl-2" href="#" id="userMenuDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <div class="media media-card media--card shadow-none mb-0 rounded-0 align-items-center bg-transparent">
                                            <div class="media-img media-img-xs flex-shrink-0 rounded-full mr-2">
                                                <img src="{{ asset('uploads/' . Auth::user()->image_url) }}" alt="avatar" class="rounded-full">
                                            </div>
                                            <div class="media-body p-0 border-left-0">
                                    ...
                                    <div class="dropdown-menu dropdown--menu dropdown-menu-right mt-3 keep-open" aria-labelledby="userMenuDropdown">
                                        ...
                                        <div class="dropdown-item-list">
                                            ...
                                            <a style="display: flex; justify-content:space-between; align-items: center" class="dropdown-item" href="index.html">
                                                <i class="la la-power-off mr-2"></i>
                                                <form action="{{ route('logout') }}" method="post">
                                                    @csrf
                                                    <button type="submit" style="border: none; color:inherit;">Logout</button>
                                                </form>
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-3">
                    <div class="hero-list hero-list-bg">
                        <div class="d-flex align-items-center pb-30px">
                            <img src="{{ asset('assets/front/images/anonymousHeroQuestions.svg') }}" alt="question icon" class="mr-3">
                            <p class="fs-15 text-white lh-20">Anybody can ask a question</p>
                        </div>
                        <div class="d-flex align-items-center pb-30px">
                            <img src="{{ asset('assets/front/images/anonymousHeroAnswers.svg') }}" alt="question answer icon" class="mr-3">
                            <p class="fs-15 text-white lh-20">Anybody can answer</p>
                        </div>
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('assets/front/images/anonymousHeroUpvote.svg') }}" alt="vote icon" class="mr-3">
...
<!-- Mirrored from techydevs.com/demos/themes/html/disilab-demo/disilab/home-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Jul 2021 10:18:19 GMT -->
